...
<div class="context-header ">
	<div class="grid-container">
		...
		<div class="item-header" data-view="itemHeader">
			<div class="item-header__title">
				<h1 class="t-heading -color-inherit -size-l h-remove-margin is-hidden-phone" itemprop="name">Obsolute | Ghost Blog Theme</h1>
				<h1 class="t-heading -color-inherit -size-xs h-remove-margin is-hidden-tablet-and-above">Obsolute | Ghost Blog Theme</h1>
			</div>
			<div class="item-header__price">
				<a href="/cart/configure_before_adding/12897637" class="js-item-header__cart-button e-btn--3d -color-primary -size-m" data-view="modalAjax" rel="nofollow" title="Add to Cart">
					...
					<span class="t-heading -size-m -color-light -margin-none">
						<b class="t-currency"><span class="js-item-header__price"> 480,000 ₫</span></b>
					</span>
				</a>
			</div>
		</div>
	<!-- Desktop Item Navigation -->
		<div class="is-hidden-tablet-and-below page-tabs">
			<ul>
				<li class="selected"><a href="" class="t-link -decoration-none">Mã sản phẩm: 20463</a></li>
		...
		<div class="content-s">
			<div class="box--no-padding">
				<div class="item-preview -preview-live">
					<a href="/preview/Obsolute--Ghost-Blog-Theme-p20463.html" target="_blank"><img alt="Obsolute | Ghost Blog Theme" itemprop="image" src="https://image-tf.s3.envato.com/files/209567089/Preview%20image.__large_preview.jpg"/></a>
					<div class="item-preview__actions">
						<div id="fullscreen" class="item-preview__preview-buttons">
							<a href="/preview/Obsolute--Ghost-Blog-Theme-p20463.html" role="button" class="btn-icon live-preview" target="_blank" rel="nofollow">Live Preview</a>
						</div>
